# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/src/utils.plot.ipynb.

# %% auto 0
__all__ = ["mlp_ims", "mlp_dms", "mlp_dms_singular"]

# %% ../../nbs/src/utils.plot.ipynb 1
import numpy as np
import pandas as pd
