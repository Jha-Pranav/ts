  ...
  'syms': { 'ts..venv.bin.activate_this': {},
            ...
            'ts.preprocess.dataloader': { 'ts.preprocess.dataloader.TSDataLoader': ( 'utils/preprocess.dataloader.html#tsdataloader',
                                          ...
                                          'ts.preprocess.dataloader.UnivariateTSDataModule._create_dataloader': ( 'utils/preprocess.dataloader.html#univariatetsdatamodule._create_dataloader',
                                                                                                                  'ts/preprocess/dataloader.py'),
                                          'ts.preprocess.dataloader.UnivariateTSDataModule._generate_windows': ( 'utils/preprocess.dataloader.html#univariatetsdatamodule._generate_windows',
                                                                                                                 'ts/preprocess/dataloader.py'),
                                          'ts.preprocess.dataloader.UnivariateTSDataModule._load_all_scalers': ( 'utils/preprocess.dataloader.html#univariatetsdatamodule._load_all_scalers',
                                                                                                                 'ts/preprocess/dataloader.py'),
