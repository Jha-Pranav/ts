# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/benchmarks/benchmark.classification.ipynb.

# %% auto 0
__all__ = ['train_transforms', 'benchmark', 'ds_list']

# %% ../../nbs/benchmarks/benchmark.classification.ipynb 1
import json
...
# %% ../../nbs/benchmarks/benchmark.classification.ipynb 2
...
# %% ../../nbs/benchmarks/benchmark.classification.ipynb 3
...
# %% ../../nbs/benchmarks/benchmark.classification.ipynb 4
for dataset in ds_list:
    print("Processing >>  ", dataset)
    # Load class labels
